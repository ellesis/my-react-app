      ...
      <div className="row flex-nowrap">
            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li>
                <a href="#submenu1" data-bs-toggle="collapse" className="nav-link px-0 align-middle">
                  <i className="fas fa-tachometer-alt"></i> <span className="ms-1 d-none d-sm-inline">Dashboard</span>{' '}
                </a>
              ...
              <li>
                <a href="#" className="nav-link px-0 align-middle">
                  <i className="fas fa-table"></i> <span className="ms-1 d-none d-sm-inline">Orders</span>
                </a>
              </li>
              <li>
                <a href="#submenu2" data-bs-toggle="collapse" className="nav-link px-0 align-middle ">
                  <i className="fab fa-bootstrap"></i> <span className="ms-1 d-none d-sm-inline">Bootstrap</span>
                </a>
              ...
              <li>
                <a href="#submenu3" data-bs-toggle="collapse" className="nav-link px-0 align-middle">
                  <i class="fas fa-th-large"></i> <span className="ms-1 d-none d-sm-inline">Products</span>{' '}
                </a>
              ...
              <li>
                <a href="#" className="nav-link px-0 align-middle">
                  <i class="fas fa-users"></i> <span className="ms-1 d-none d-sm-inline">Customers</span>{' '}
                </a>
              </li>
            </ul>
            <hr />
        ...
        <div className="col py-3">
          ...
          <p className="lead">
            ...
            single menu is be open at a time. While the sidebar itself is not toggle-able, it does responsively shrink
